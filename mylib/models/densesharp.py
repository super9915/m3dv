...
PARAMS = {
    ...
    'first_scale': lambda x: x / 255.,  # the first pre-processing function
    #'first_scale': lambda x: (x-128.)/ 68.,
    #'first_scale':None,
...
def get_model(weights=None, verbose=True, **kwargs):
    ...
    downsample_times = len(down_structure) # 3
    top_down = []
